...
public class DateAndTime_02_Test {
    ...
    public void test_localDate_of() {
        ...
        int dayOfMonth = 24;
        DayOfWeek dayOfWeek = DayOfWeek.from(result);
    ...
    public void test_localDate_parse() {
        ...
        LocalDate result = LocalDate.of(1990, Month.JANUARY, 10);
    ...
    public void test_with() {
        ...
        LocalDate result = localDate.withDayOfMonth(05).plusMonths(1).withYear(2015);
